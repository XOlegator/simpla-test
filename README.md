...
composer update
```
2. Обновить файл /api/Retail.php
3. Проверить и при необходимости обновить согласно (Установка для мгновенной выгрузки данных по заказам и клиентам в RetailCRM)[#Установка для мгновенной выгрузки данных по заказам и клиентам в RetailCRM]
4. Удалить файлы orders.php и Tools.php из каталога /integration (теперь код из них содержится в /api/Retail.php)
